...
@include('admin.layout.core.main-sider')
...
@if(\Illuminate\Support\Facades\Session::has('addSuccess'))
    <script>
        toastr.success("{!! Session::get('addSuccess') !!}")
    </script>
@endif
@if(\Illuminate\Support\Facades\Session::has('updateSuccess'))
    <script>
